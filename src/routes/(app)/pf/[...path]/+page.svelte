<!-- <script lang="ts">
	...
	const portfolioId = $derived(segments[2]);
	const projectId = $derived(segments[4]);
	const milestoneId = $derived(segments[6]);
...
<TaskModal {milestone} {project} {membersByProject}></TaskModal> -->

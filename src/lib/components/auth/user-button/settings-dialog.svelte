...
<Dialog.Root bind:open>
	...
	<Dialog.Content
		class="max-h-[80dvh] overflow-y-auto p-0 md:max-h-[500px] md:max-w-[700px] md:overflow-hidden lg:max-w-[800px]"
	>
		...
		<Sidebar.Provider class="items-start">
			...
			<main class="flex flex-1 flex-col overflow-hidden sm:h-auto md:h-[480px]">
				<header

<!-- Empty State -->
<div class="flex min-h-96 flex-col items-center justify-center p-5 text-center">
	<svg
	...
	<div class="mx-auto max-w-sm">
		<p class="mt-2 font-medium text-gray-800 dark:text-neutral-200">No syncs created</p>
		<p class="mb-5 text-sm text-gray-500 dark:text-neutral-500">
			You haven't created any syncs yet. Get started by creating your first sync.
		</p>
	</div>
</div>
<!-- End Empty State -->

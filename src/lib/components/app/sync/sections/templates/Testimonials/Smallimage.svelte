<script lang="ts">
	...
	const testimonial = {
		image:
			'https://images.unsplash.com/photo-1671726203390-cdc4354ee2eb?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80',
		quote:
...
<div class="relative overflow-hidden">
	<div class="mx-auto max-w-[85rem] px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
		<!-- Gradients -->
		<div aria-hidden="true" class="absolute start-0 -z-[1] flex">
			<div
				class="h-[300px] w-[1036px] bg-purple-200 opacity-20 blur-3xl"
			></div>
		</div>
		<!-- End Gradients -->

		<!-- Grid -->
		<div class="lg:grid lg:grid-cols-6 lg:items-center lg:gap-8">
			<div class="hidden lg:col-span-2 lg:block">
				<img class="rounded-xl" src={testimonial.image} alt="Image Description" />
			</div>
			<!-- End Col -->
			...
			<div class="lg:col-span-4">
				...
				<Card.Root>
					...
					<Card.Content>
						<p
							class="text-xl font-medium text-gray-800 lg:text-2xl lg:leading-normal"
						>
							{testimonial.quote}
						</p>
					</Card.Content>
